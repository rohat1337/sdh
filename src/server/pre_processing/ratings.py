...
def do_work_ranked():
    ...
    # Sweden (1/2)
    df_1 = read_df("Allsvenskan_180123", "Allsvenskan")
    df_2 = read_df("Superettan_180123", "Superettan")
    # Denmark (1/2)
    df_3 = read_df("Superliga_180123", "Superliga")
    df_4 = read_df("1st_Division_180123", "1. Division")
    # Norway (1/2)
    df_5 = read_df("Eliteserien_180123", "Eliteserien")
    df_6 = read_df("Obos_Ligaen_180123", "OBOS-ligaen")
    # Bosnia (1)
    df_7 = read_df("Premijer_Liga_180123", "Premijer_Liga_180123")
    # Finland (1)
    df_8 = read_df("Veikkausliiga_180123", "Veikkausliiga")
    # Iceland (1)
    df_9 = read_df("Besta-deild_karla_180123", "Besta-deild karla")
    # Netherland (1/2)
    df_10 = read_df("Eredivisie_O25_180123", "Eredivise")
    df_11 = read_df("Eredivisie_U25_180123", "Eredivise")
    df_12 = read_df("Eerste_Divisie_U23_180123", "Eerste Divisie")
    df_13 = read_df("Eerste_Divisie_O23_180123", "Eerste Divisie")
    # Serbia (1)
    df_14 = read_df("Serbia_Super_liga_O25_180123", "SuperLiga")
    df_15 = read_df("Serbia_Super_liga_U25_180123", "SuperLiga")
    # Germany
    df_16 = read_df("3_Bundesliga_U25_180123", "3. Bundesliga")
    df_17 = read_df("3_Bundesliga_O25_180123", "3. Bundesliga")



    df = pd.concat([df_1, df_2, df_3, df_4, df_5, df_6, df_7, df_8, df_9, df_10, df_11, df_12, df_13, df_14, df_15, df_16, df_17])
