...
function Dashboard(props) {
    ...
    let skapaMalchans = ["xG", "Assists", "xA", "Successful attacking actions per", "Head goals", "Head goals per 90", "Shots", "Shots per 90", "Shots on target, %", "Goal conversion, %", "Assists per 90"]
    let speluppbyggnad = ["Duels per 90", "Duels won, %"]
    let forsvarsspel = ["Successful defensive actions per 90", "Defensive duels per 90", "Defensive duels won, %", "Shots blocked per 90", "Interceptions per 90"]
